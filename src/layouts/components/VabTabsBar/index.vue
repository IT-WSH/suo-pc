  ...
  <div id="tabs-bar-container" class="tabs-bar-container">
    ...
    <el-dropdown @command="handleCommand">
      ...
      <el-dropdown-menu slot="dropdown" class="tabs-more">
        ...
        <el-dropdown-item class="tabs-more-item" command="closeOtherstabs">
          <vab-icon class="item-icon" :icon="['fas', 'times-circle']" />
          关闭其他
        </el-dropdown-item>
        <el-dropdown-item class="tabs-more-item" command="closeLefttabs">
          <vab-icon
            class="item-icon"
        ...
        <el-dropdown-item class="tabs-more-item" command="closeRighttabs">
          <vab-icon
            class="item-icon"
        ...
        <el-dropdown-item class="tabs-more-item" command="closeAlltabs">
          <vab-icon class="item-icon" :icon="['fas', 'ban']"></vab-icon>
          关闭全部
        </el-dropdown-item>
      </el-dropdown-menu>
    </el-dropdown>
...
<script>
  ...
  export default {
    ...
    methods: {
      async handleClose(obj) {
        let tabActive = obj.path
        let view
        this.visitedRoutes.forEach((item, index) => {
